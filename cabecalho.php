...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><i class="fa fa-paint-brush fa-flip-horizontal"></i> &nbsp Tattoo<strong></strong></a> </div>
    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#home" class="page-scroll"><i class="fa fa-home fa-flip-horizontal">&nbsp</i> Home</a></li>
        <li><a href="#services-section" class="page-scroll"><i class="fa fa-spinner fa-flip-horizontal">&nbsp</i> Sobre</a></li>
